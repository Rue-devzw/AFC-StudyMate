...
/// the `win32` package. However, newer versions of `win32` no longer export this
/// value, which breaks compilation when this plugin is built.  Defining the
...
class QuillNativeBridgeWindows extends QuillNativeBridgePlatform {
  ...
  Future<void> copyHtmlToClipboard(String html) async {
    ...
    try {
      ...
      final clipboardMemoryHandle = GlobalAlloc(_kGlobalAllocMoveable, htmlSize);
